    ...
    return (
        <div className='py-10 max-w-screen-xl mx-auto'>
            ...
            <div className='grid grid-cols-2 gap-16 pt-12'>
                <div className="">
                    <h3 className='text-2xl font-display font-bold mb-4 text-white font-grotesk'>Powerful Webhooks</h3>
                    <p className='text-[#707d8f] text-base'>Real-time notifications when interviews complete. Auto-sync with your ATS, CRM, or custom systems.</p>
                    <ul className='flex flex-col gap-3 py-6'>
                        <li className='flex items-center gap-2 text-sm text-[#d1d9e0]'>
                ...
                <div className='p-[1.5px] rounded-[13px] bg-gradient-to-br from-[#00bfff26] via-[#8a5cf623] to-[#00bfff20]'
                    ...
                    <div className="h-full bg-[#111318] rounded-[11px]">
                        <div className='w-full border-b border-white/10 px-4 flex items-center gap-3 py-4'>
                            ...
                            <span className='text-xs text-[#707d8f] ml-2 font-mono'>webhook_payload.json</span>
                        </div>
